 ...
 */
@Entity
@Table(name = "sales_by_film_category", schema = "public")
public class SalesByFilmCategory implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "category", column = @Column(name = "category", length = 25)),
			@AttributeOverride(name = "totalSales", column = @Column(name = "total_sales", precision = 0, scale = 0)) })
